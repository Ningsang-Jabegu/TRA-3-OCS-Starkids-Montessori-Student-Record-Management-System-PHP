        ...
        <div class="form-row">
            ...
            <div class="form-group">
                ...
                <input type="text" name="first_name"
                    ...
                    value="<?php echo $first_name ?? ''; ?>" id="first_name">
            ...
            <div class="form-group">
                ...
                <input type="text" name="middle_name"
                    ...
                    value="<?php echo $middle_name ?? ''; ?>" id="middle_name">
        ...
        <div class="form-row">
            ...
            <div class="form-group">
                ...
                <select name="blood_group"
                    ...
                    <option value="">Select</option>
                    <option value="A+" <?php echo (isset($blood_group) && $blood_group == 'A+') ? 'selected' : ''; ?>>A+
                    </option>
                    <option value="A-" <?php echo (isset($blood_group) && $blood_group == 'A-') ? 'selected' : ''; ?>>A-
                    </option>
                    <option value="B+" <?php echo (isset($blood_group) && $blood_group == 'B+') ? 'selected' : ''; ?>>B+
                    </option>
                    <option value="B-" <?php echo (isset($blood_group) && $blood_group == 'B-') ? 'selected' : ''; ?>>B-
                    </option>
                    <option value="AB+" <?php echo (isset($blood_group) && $blood_group == 'AB+') ? 'selected' : ''; ?>>
                        AB+
                    </option>
                    <option value="AB-" <?php echo (isset($blood_group) && $blood_group == 'AB-') ? 'selected' : ''; ?>>
                        AB-
                    </option>
                    <option value="O+" <?php echo (isset($blood_group) && $blood_group == 'O+') ? 'selected' : ''; ?>>O+
                    </option>
                    <option value="O-" <?php echo (isset($blood_group) && $blood_group == 'O-') ? 'selected' : ''; ?>>O-
                    </option>
            ...
            <div class="form-group">
                ...
                <select name="nationality"
                    ...
                    <option value="">Select</option>
                    <option value="Nepal" <?php echo (isset($nationality) && $nationality == 'Nepal') ? 'selected' : ''; ?>>
                        Nepal
                    </option>
                    <option value="India" <?php echo (isset($nationality) && $nationality == 'India') ? 'selected' : ''; ?>>
                        India
                    </option>
                    <option value="China" <?php echo (isset($nationality) && $nationality == 'China') ? 'selected' : ''; ?>>
                        China
                    </option>
            ...
            <div class="form-group">
                ...
                <select name="ethnicity"
                    class="form-control <?php echo (!empty($errors["ethnicity"])) ? 'is-invalid' : ''; ?>">
                    <option value="">Select</option>
                    ...
                    <option value="Chhetri" <?php echo (isset($ethnicity) && $ethnicity == 'Chhetri') ? 'selected' : ''; ?>>
                        Chhetri</option>
                    <option value="Newar" <?php echo (isset($ethnicity) && $ethnicity == 'Newar') ? 'selected' : ''; ?>>
                        Newar
                    </option>
                    <option value="Tamang" <?php echo (isset($ethnicity) && $ethnicity == 'Tamang') ? 'selected' : ''; ?>>
                        Tamang
                    </option>
                    <option value="Magar" <?php echo (isset($ethnicity) && $ethnicity == 'Magar') ? 'selected' : ''; ?>>
                        Magar
                    </option>
                    <option value="Tharu" <?php echo (isset($ethnicity) && $ethnicity == 'Tharu') ? 'selected' : ''; ?>>
                        Tharu
                    </option>
                    <option value="Gurung" <?php echo (isset($ethnicity) && $ethnicity == 'Gurung') ? 'selected' : ''; ?>>
                        Gurung
                    </option>
                    <option value="Rai" <?php echo (isset($ethnicity) && $ethnicity == 'Rai') ? 'selected' : ''; ?>>Rai
                    </option>
                    <option value="Limbu" <?php echo (isset($ethnicity) && $ethnicity == 'Limbu') ? 'selected' : ''; ?>>
                        Limbu
                    </option>
                    <option value="Sherpa" <?php echo (isset($ethnicity) && $ethnicity == 'Sherpa') ? 'selected' : ''; ?>>
                        Sherpa
                    </option>
                    <option value="Other" <?php echo (isset($ethnicity) && $ethnicity == 'Other') ? 'selected' : ''; ?>>
                        Other
                    </option>
                </select>
            ...
            <div class="form-group">
                ...
                <select name="religion"
                    ...
                    <option value="Buddhism" <?php echo (isset($religion) && $religion == 'Buddhism') ? 'selected' : ''; ?>>
                        Buddhism</option>
                    <option value="Islam" <?php echo (isset($religion) && $religion == 'Islam') ? 'selected' : ''; ?>>
                        Islam
                    </option>
                    <option value="Kirat" <?php echo (isset($religion) && $religion == 'Kirat') ? 'selected' : ''; ?>>
                        Kirat
                    </option>
                    ...
                    <option value="Prakriti" <?php echo (isset($religion) && $religion == 'Prakriti') ? 'selected' : ''; ?>>
                        Prakriti</option>
                    <option value="Bon" <?php echo (isset($religion) && $religion == 'Bon') ? 'selected' : ''; ?>>Bon
                    </option>
                    <option value="Jainism" <?php echo (isset($religion) && $religion == 'Jainism') ? 'selected' : ''; ?>>
                        Jainism
                    </option>
                    <option value="Sikhism" <?php echo (isset($religion) && $religion == 'Sikhism') ? 'selected' : ''; ?>>
                        Sikhism
                    </option>
                    <option value="Other" <?php echo (isset($religion) && $religion == 'Other') ? 'selected' : ''; ?>>
                        Other
                    </option>
                </select>
            ...
            <div class="form-group">
                ...
                <select name="class" class="form-control <?php echo (!empty($errors["class"])) ? 'is-invalid' : ''; ?>">
                    <option value="">Select</option>
                    <option value="Nursary" <?php echo (isset($class) && $class == 'Nursary') ? 'selected' : ''; ?>>
                        Nursary
                    </option>
...
<div class="form-row">
    ...
    <div class="form-group">
        ...
        <small class="form-text text-muted">Note: Roll number is auto-generated and subject to change before
            final
            admission.</small>
